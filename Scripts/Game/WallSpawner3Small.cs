...
namespace Game
{
    public class WallSpawner3Small : ScriptBehaviour
    {
        // ================== Spawn Setting ============================
        ...
        public override void OnUpdate(float deltaTime){
            ...
            if(spawntimer <= 0.0f){
                try{
                    ...
                    LogMessage("[WallSpawner3Small] ERRROR during spawn: " + e.ToString());
                }
                finally{
        ...
        private void OnGameEnd(string eventName, string payload){
            LogMessage("[WallSpawner3Small] GameEnd detected disallowing spawning");
            canSpawn = false;
        }
        ...
        private void SpawnRandomEnemyOnWall(){
            ...
            if(enemyID == 0){
                LogMessage("[WallSpawner3Small] Fail to instantiate enemy for: " + enemyPrefabPath);
                return;
            }
            ...
            if(enemyDex == 0){
                ...
                if(warpingInID == 0){
                    LogMessage("[WallSpawner3Small] loveletter warping in entity fail to instantiate");
                    return;
                }
            }
        }
