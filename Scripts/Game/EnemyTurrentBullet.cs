...
namespace Game
{
    public class EnemyTurretBullet : ScriptBehaviour
    {
        [SerializeField]
        ...
        {
            TagSetTag((uint)EntityID, "EnemyTurretBullet");
            if (enableDebug)
            {
                LogMessage("===== EnemyTurretBullet STARTED =====");
                LogMessage("EnemyTurretBullet EntityID: " + EntityID);
                LogMessage("Checking EnemyTurretBullet components...");
            }
        ...
        public override void OnUpdate(float deltaTime)
        {
            ...
            {
                if (enableDebug)
                    LogMessage("EnemyTurretBullet " + EntityID + " lifetime expired, destroying...");
        ...
        private void OnBulletHitTarget(uint bulletEntityID, uint targetEntityID)
        {
            ...
            LogMessage("===== ENEMY TURRET BULLET HIT TARGET! =====");
            LogMessage("Bullet EntityID: " + bulletEntityID + " hit Target EntityID: " + targetEntityID);
