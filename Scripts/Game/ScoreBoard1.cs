...
namespace Game
{
    ...
    public class ScoreBoard1 : ScriptBehaviour
    {
        ...
        private string currentLevel = "Level1_NewPlayer"; // TODO: set this to your scene name
        ...
        private void SaveScore()
        {
            ...
            try
            {
                ...
                {
                    scoreSaved = true;
                    LogMessage("[ScoreBoard1] Score " + score + " saved for " + currentLevel);
                    LogMessage("[ScoreBoard1] Leaderboard: " + string.Join(", ", levelScores));
                }
                else
                {
