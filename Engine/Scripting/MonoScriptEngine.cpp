		...
		static uint64_t Prefab_InstantiateWithTransform(MonoString *prefabPathStr, glm::vec3 *position, glm::vec3 *rotation, glm::vec3 *scale, bool isScenePrefab) {
			...
			if(!entity) {
				...
				if(entity.HasComponent<TransformComponent>()) {
					...
					// Quats are the main storage; rotation is assumed to be Euler (radians) here.
					// Convert Euler -> quat before assigning.
					...
					// Manually calculate WorldTransform immediately
