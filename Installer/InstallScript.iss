...
AppId={{EB95BD3B-A6E7-409A-8741-85BAB53996C6}

; Standard app data stuff
; !!NOTE!!: Replace all instances of "GuardianOfTheMotherboard" with your game name.
AppName=GuardianOfTheMotherboard
AppVerName=GuardianOfTheMotherboard Version 0.1
...
DefaultDirName={localappdata}\DigiPen\GuardianOfTheMotherboard
...
OutputBaseFilename=GuardianOfTheMotherboard_Setup
...
[Icons]
Name: {group}\GuardianOfTheMotherboard; Filename: {app}\GameEngine.exe; WorkingDir: {app}; IconFilename: "{app}\SetupIcon.ico"
Name: {group}\{cm:UninstallProgram,GuardianOfTheMotherboard}; Filename: {uninstallexe}
Name: {group}\{cm:UninstallProgram,GuardianOfTheMotherboard}; Filename: {uninstallexe};  IconFilename: "{app}\SetupIcon.ico"
Name: {commondesktop}\GuardianOfTheMotherboard; Filename: {app}\GameEngine.exe; Tasks: desktopicon; WorkingDir: {app}; IconFilename: "{app}\SetupIcon.ico"
